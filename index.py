...
BUCKET = "myrawimagesjin" # e.g. rekognition-workshop
IMAGE = "pexels-photo-415829.jpeg"  # e.g. raw_image.jpg
COLLECTION = "mycollectionjin" # e.g. rekognition-workshop
PROCESSED_IMAGE = "myprocessedimagesjin" # e.g. processed_image.jpg
